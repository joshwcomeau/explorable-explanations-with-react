...
import LocalCanvas from './Canvas';
...
class Confetti extends Component {
  ...
  static defaultProps = {
    shapes: [
      createZigZag({ fill: COLORS.pink[500] }),
      createZigZag({ fill: COLORS.blue[500] }),
      createZigZag({ fill: COLORS.green[500] }),
      createZigZag({ fill: COLORS.yellow[700] }),
      createCircle({ fill: COLORS.purple[500] }),
      createCircle({ fill: COLORS.orange[500] }),
      createCircle({ fill: COLORS.red[500] }),
      createCircle({ fill: COLORS.indigo[500] }),
      createTriangle({ fill: COLORS.pink[500] }),
      createTriangle({ fill: COLORS.purple[700] }),
      createTriangle({ fill: COLORS.yellow[500] }),
    ],
    numParticles: 80,
